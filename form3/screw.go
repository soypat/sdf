...
func Screw3D(thread sdf.SDF2, length float64, taper float64, pitch float64, starts int) sdf.SDF3 {
	if thread == nil {
		panic("thread == nil")
	}
	if length <= 0 {
...
func (s *ScrewSDF3) Evaluate(p r3.Vec) float64 {
...
func (s *ScrewSDF3) BoundingBox() d3.Box {
	return s.bb
}
